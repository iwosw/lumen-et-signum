...
All rights reserved. Исходный код и документация доступны публично, но не являются open source. Копирование, изменение, распространение, продажа или использование без письменного разрешения правообладателя запрещены. См. [`LICENSE`](LICENSE).
